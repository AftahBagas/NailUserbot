...
tg_sendinfo "<code>I am gonna merge staging into NailUserbot</code>"
cd
...
git push --force origin staging:NailUserbot
tg_sendinfo "<code>I have merged all commits from staging into NailUserbot</code>"
